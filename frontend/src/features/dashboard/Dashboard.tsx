...
const Dashboard: React.FC = () => {
    const { locations, loading, error } = useDashboard();
        ...
        <div className="p-4 md:p-8 space-y-6 md:space-y-8 animate-in fade-in duration-500">
            <header className="flex flex-col md:flex-row gap-4 md:justify-between md:items-center">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">
                        Monitoreo de riesgo en tiempo real en todo el distrito.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                {[
                    ...
                    {
                        label: "Riesgo Alto",
                        value: locations.filter(l => l.currentRiskScore > 70).length,
                        icon: AlertTriangle
                    },
                    {
                        label: "Cumplimiento",
                    ...
                    <div
                        key={i}
                        className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-slate-100"
                    >
                            ...
                            <div key={i} className="flex gap-4 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-500 font-medium">
                                        Riesgo ajustado a {l.currentRiskScore}
                                    </p>
                                </div>
                            </div>
                        ))}
